...
namespace Appointment.Data.Migrations
{
    ...
    [Migration("20231210182022_add-identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Appointment.Domain.Entities.Identity.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Appointment.Domain.Entities.Identity.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Appointment.Domain.Entities.Availabillity", b =>
                {
                    b.HasOne("Appointment.Domain.Entities.Identity.User", "User")
            ...
            modelBuilder.Entity("Appointment.Domain.Entities.Visit", b =>
                {
                    ...
                    b.HasOne("Appointment.Domain.Entities.Identity.User", "Therapist")
                        .WithMany("Visits")
